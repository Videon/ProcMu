...
namespace Azure.StorageServices
{
    public class BlobService
    {
        ...
        public IEnumerator PutJsonBlob(Action<RestResponse> callback, string text, string resourcePath, string filename, string contentType = "application/json; charset=UTF-8")
        {
            byte[] bytes = Encoding.UTF8.GetBytes(text);
            return PutBlob(callback, bytes, resourcePath, filename, contentType);
        }
